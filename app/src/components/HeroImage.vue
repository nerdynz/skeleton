<template>
  <building-block title="Hero Image" :block="block" class="hero-image-block ">
    <div class="columns is-multiline mt-1">
      <div class="column is-full ">
        <div class="is-relative">
          <div class="image is-16by9">
            <image-crop :image="block.imageOne" class="is-overlay" :cropper-width="1920" :cropper-height="1080"
              :width="1920" :height="1080" @apply="apply" />
          </div>
        </div>
      </div>
    </div>
